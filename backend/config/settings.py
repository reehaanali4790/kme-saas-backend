...
os.makedirs(os.path.join(settings.UPLOAD_DIR, "invoice_documents", "_staged"), exist_ok=True)
os.makedirs(os.path.join(settings.UPLOAD_DIR, "packing_documents", "_staged"), exist_ok=True)
os.makedirs(os.path.join(settings.UPLOAD_DIR, "fi_documents", "_staged"), exist_ok=True)
os.makedirs(os.path.join(settings.UPLOAD_DIR, "insurance_documents"), exist_ok=True)
os.makedirs(os.path.join(settings.UPLOAD_DIR, "insurance_documents", "_staged"), exist_ok=True)
...
os.makedirs(os.path.join(settings.UPLOAD_DIR, "gd_documents", "_staged"), exist_ok=True)
os.makedirs(os.path.join(settings.UPLOAD_DIR, "gd_attachments", "_staged"), exist_ok=True)
...
os.makedirs(os.path.join(settings.UPLOAD_DIR, "contract_documents"), exist_ok=True)

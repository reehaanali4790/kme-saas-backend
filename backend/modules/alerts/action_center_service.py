...
CATEGORY_MAP = {
    "DOCUMENT": {"MISSING_DOCUMENT", "ARRIVAL_DOCS_MISSING", "POST_SHIP_DOCS_MISSING", "DA_DOC_ARRIVAL", "DISCREPANCY"},
    "CUSTOMS": {"GD_FILING_DUE", "GD_FILING_OVERDUE", "GD_LATE_FILED", "EX_BOND_EXCEEDED", "INTO_BOND", "CONTAINER_LFD"},
    "LC_DATES": {"LC_EXPIRING", "LAST_SHIP_DATE", "FI_EXPIRY", "SHORT_SHIPMENT",
                 "SRO_QUOTA_EXCEEDED", "SRO_QUOTA_EXPIRED", "SRO_QUOTA_80", "SRO_QUOTA_90"},
    "LME": set(),
}
